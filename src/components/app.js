      ...
      if (this.state.index){
        return (
          <div id="eventContainer">
            {this.state.selectedEvent ? <div className="background-2" style={{backgroundImage:`url(${this.state.selectedEvent.logo.url})`, backgroundSize:'cover'}}></div> : <div className="background-2" style={{backgroundImage:`url()`, backgroundSize:'cover'}}></div> }  
          <Logout />
          <div className="row">
